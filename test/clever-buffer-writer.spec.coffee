...
describe 'CleverBuffer', ->
  ...
  it 'should write bytes', ->
    ...
    cleverBufferWriter.write [0x57, 0x68, 0x61, 0x74, 0x20, 0x6d, 0x65, 0x20, 0x57, 0x6f, 0x72, 0x72, 0x79, 0x21]

    cleverBufferWriter.getBuffer().should.eql new Buffer [0x57, 0x68, 0x61, 0x74, 0x20, 0x6d, 0x65, 0x20, 0x57, 0x6f, 0x72, 0x72, 0x79, 0x21]
